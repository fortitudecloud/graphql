...
function getResolvers(db) {
    ...
    return {
        Query: {
            todo: function (root, _a) {
                var id = _a.id;
                return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_b) {
                        return [2 /*return*/, db.getData('/todo/' + id)];
                    });
                });
            },
            todos: function () { return __awaiter(_this, void 0, void 0, function () {
                var todos, dbTodos, td;
                return __generator(this, function (_a) {
                    todos = [];
                    dbTodos = db.getData('/todo');
                    for (td in dbTodos) {
        ...
        Mutation: {
            createTodo: function (root, args, context, info) { return __awaiter(_this, void 0, void 0, function () {
                var res;
                return __generator(this, function (_a) {
